...
export default function DiagonalButton({
  ...
  return (
    <button
      onClick={onClick}
      className={`relative uppercase font-bold text-[17px] border-2 border-white px-5 py-2 text-white overflow-hidden transition-all duration-1000 hover:text-black group rounded-xl ${className}`}
    >
